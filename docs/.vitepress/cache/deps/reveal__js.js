...
var g = /(iphone|ipod|ipad|android)/gi.test(u) || "MacIntel" === navigator.platform && navigator.maxTouchPoints > 1;
/chrome/i.test(u) && /edge/i.test(u);
var v = /android/gi.test(u);
var p = {};
...
var R = /registerPlugin|registerKeyboardShortcut|addKeyBinding|addEventListener|showPreview/;
var S = /fade-(down|up|right|left|out|in-then-out|in-then-semi-out)|semi-fade-out|current-visible|shrink|grow/;
var A = 0;
var k = class {
  constructor(e2) {
    this.Reveal = e2;
...
var reveal_esm_default = W;
export {
  reveal_esm_default as default
};
